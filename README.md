...
This will start the Vite development server (usually on `http://localhost:5173`). Both players can play from the same device/browser.
...
This starts the Express + Socket.IO server on port 4000.
